...
namespace MyIssue.Core.Constants
{
    ...
    {
        public const string insertTask = "INSERT INTO {0}(taskTitle, taskDesc, taskCreation, taskClient, taskType, mailId)VALUES(@TITLE, @DESC, @DATE, (SELECT [clientId] FROM {1} WHERE [clientName] = @CLIENT), @TYPE, @MAILID)";
