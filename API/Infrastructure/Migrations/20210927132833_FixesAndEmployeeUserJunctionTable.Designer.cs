...
namespace MyIssue.API.Infrastructure.Migrations
{
    ...
    [Migration("20210927132833_FixesAndEmployeeUserJunctionTable")]
    partial class FixesAndEmployeeUserJunctionTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyIssue.API.Model.EmployeeUser", b =>
                {
                    b.Property<string>("EmployeeLogin")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("MyIssue.API.Model.EmployeeUser", b =>
                {
                    b.HasOne("MyIssue.API.Model.Employee", "Employee")
                        ...
                        .HasForeignKey("MyIssue.API.Model.EmployeeUser", "EmployeeLogin")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyIssue.API.Model.User", "User")
                        .WithOne("EmployeeUser")
                        .HasForeignKey("MyIssue.API.Model.EmployeeUser", "UserLogin")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyIssue.API.Model.Task", b =>
                {
                    b.HasOne("MyIssue.API.Model.Employee", null)
                        .WithMany("Tasks")
                        .HasForeignKey("EmployeeLogin");

                    b.HasOne("MyIssue.API.Model.Employee", "EmployeesAssignment")
                        .WithMany()
                    ...
                    b.HasOne("MyIssue.API.Model.Employee", "EmployeesOwnership")
                        .WithMany()
                    ...
                    b.Navigation("EmployeesAssignment");

                    b.Navigation("EmployeesOwnership");
